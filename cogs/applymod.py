...
class dm_mod(Cog):
    ...
    async def applymod(self, ctx: Context):
        ...
        """
        if ctx.guild.id != 741614680652644382:
            return await ctx.send("This command is only used in Support Server"
                                  )
        ...
        questions = [
            ...
            'Why you want to be Moderator?', 'Anything else you want to say?',
