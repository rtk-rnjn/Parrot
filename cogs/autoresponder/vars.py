...
class Variables:
    ...
    def __init__(self, *, message: discord.Message, bot: Parrot):
        self.__message = message  # type: ignore
        self.__bot = bot  # type: ignore
    ...
    async def _create_channel(self, name: str, position: int = None, category: int = None):
        cat = self.__message.guild.get_channel(category) if category else None  # type: discord.CategoryChannel # type: ignore
