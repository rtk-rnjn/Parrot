...
class Card:
    ...
    def __eq__[E: Card](self: E, other: E) -> bool:
        return isinstance(other, self.__class__) and self.color is other.color and self.type is other.type and self.value == other.value
    ...
    def emoji(self) -> str:
        ...
        error_message = f"Invalid card type: {self.type}"
    ...
    def match[E: Card](self: E, other: E, /) -> bool:
        return other.color is self.color or other.is_wild() or self.stackable_with(other)

    def stackable_with[E: Card](self: E, other: E, /) -> bool:
        return (other.type is self.type is CardType.number and other.value == self.value) or other.type is self.type is not CardType.number
