...
TIPS = [
    ...
    "I love you.",
    "Parrot bot has it's own documentation. <https://github.com/rtk-rnjn/Parrot/wiki/Getting-Started>",
    "BOT IS OPEN SOURCE! <https://github.com/rtk-rnjn/Parrot>",
    ...
    "Parrot's privacy policy: <https://github.com/rtk-rnjn/Parrot/blob/main/privacy%20policy.md>",
    "This underrated bot is owned by ritik.ranjan, want to buy it?",
    ...
    "Once upon a time, there was a bot named Parrot. It was a very good bot. It was owned by ritik.ranjan. The end.",
...
FAQS = {
    "how to change prefix": "Use `config prefix` command. Example: `@Parrot config prefix !`",
    "how to change parrot bot prefix": "Use `config prefix` command. Example: `@Parrot config prefix !`",
}
