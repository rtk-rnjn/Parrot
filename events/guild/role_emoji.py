...
"""
        ...
        if data := await self.bot.mongo.parrot_db["global_chat"].find_one(
            {"_id": role.guild.id}
        ):
        ...
        if data := await self.bot.mongo.parrot_db["telephone"].find_one(
            {"_id": role.guild.id}
        ):
        ...
        if data := await self.bot.mongo.parrot_db["ticket"].find_one(
            {"_id": role.guild.id}
        ):
