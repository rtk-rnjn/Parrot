...
def _gather_checker():
    return discord.Embed.Empty if hasattr(discord.Embed, "Empty") else None
...
class Embed:
    ...
    async def build_author(self):
        ...
        author_icon = (
            ...
            if self.embed.author.icon_url != self.check_against
            else ""
        )
    ...
    async def build_image(self):
        self.image = (
            ...
            if self.embed.image.url != self.check_against
            else ""
        )
    ...
    async def build_thumbnail(self):
        self.thumbnail = (
            ...
            if self.embed.thumbnail.url != self.check_against
            else ""
        )
